...
#define TVMGEN_FUNCTIONS(FUNC)                                                                   \
    FUNC(tvmgen_default_fused_layout_transform_cast_subtract)                                    \
    FUNC(tvmgen_default_fused_layout_transform_reshape_cast_subtract)                            \
    FUNC(tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_per_axis_add_clip_cast)         \
    FUNC(tvmgen_default_fused_nn_conv2d_add_fixed_point_multiply_per_axis_add_clip_cast_1)       \
    FUNC(tvmgen_default_fused_nn_dense_add_fixed_point_multiply_add_clip_cast)                   \
    FUNC(tvmgen_default_fused_nn_dense_add_fixed_point_multiply_add_clip_subtract_cast_multiply) \
    FUNC(tvmgen_default_fused_nn_max_pool2d)                                                     \
    FUNC(tvmgen_default_fused_nn_max_pool2d_cast_subtract)                                       \
    FUNC(tvmgen_default_fused_nn_softmax_divide_round_add_clip_cast)                             \
    FUNC(tvmgen_default_fused_reshape_cast_subtract)
